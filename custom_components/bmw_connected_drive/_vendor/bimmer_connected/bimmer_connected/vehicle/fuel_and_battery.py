...
class FuelAndBattery(VehicleDataBase):
    ...
    def _parse_vehicle_data(cls, vehicle_data: Dict) -> Optional[Dict]:
        ...
        retval: Dict[str, Any] = {}
        drivetrain_value = vehicle_data.get(ATTR_ATTRIBUTES, {}).get("driveTrain")
        try:
            drivetrain = DriveTrainType(drivetrain_value) if drivetrain_value else DriveTrainType.UNKNOWN
        except ValueError:
